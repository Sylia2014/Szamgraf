...
{
public:
	SpaceShipCamera(void);
	SpaceShipCamera(glm::vec3 _eye, glm::vec3 _at, glm::vec3 _up);
	~SpaceShipCamera(void);
...
private:
	...
	glm::vec3	sebesseg_vektor = glm::vec3(0);
	glm::vec3	gyorsulas_vektor = glm::vec3(0);
	const float gyorsulas_konstans = 0.001;
	float roll_irany = 0.0f;
};
